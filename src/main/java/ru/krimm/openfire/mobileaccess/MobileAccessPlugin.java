...
public final class MobileAccessPlugin implements Plugin {
    ...
    public void initializePlugin(final PluginManager pluginManager, final File pluginDirectory) {
        ...
        LOGGER.info("Mobile Access plugin initialized from {} with allowed directory group '{}'",
            pluginDirectory.getAbsolutePath(), allowedGroup);
    }
    ...
    DirectoryEligibilityService getDirectoryEligibilityService() { return directoryEligibilityService; }
    MobileCredentialService getMobileCredentialService() { return mobileCredentialService; }
}
